...
SERVICES = {
    "planning-drawings": {
        ...
        "local_faqs": [
            ...
            ("What postcodes in {location} do you cover for planning drawings?",
             "We cover all {location} postcodes — {postcodes} — as well as the immediately adjacent boroughs. Survey appointments are available within 3 working days across {location}."),
            ("How does {location}'s character affect planning applications?",
             "{location}'s {typical_housing_short} housing stock and {conservation_count} conservation areas mean that design quality matters. {location_council} officers are experienced reviewers; well-drawn, consistent applications are processed faster than revisions-heavy ones."),
            ("Can I appeal a planning refusal in {location}?",
             "Yes — Planning Inspectorate appeals are available as a right within 12 weeks of refusal from {location_council}. Written representations take 16–20 weeks; hearings 24–32 weeks. We prepare appeal statements and revised drawings for cases where refusal was on design or policy grounds."),
        ],
    },
    ...
    "building-regulations": {
        ...
        "local_faqs": [
            ...
            ("What types of projects need building regulations in {location}?",
             "In {location}, building regulations are required for: loft conversions, extensions, structural alterations, roof replacements, new openings in walls, and any work to a flat. Some minor works (like-for-like replacements, small porches) are exempt. We confirm at the free site visit."),
            ("What is a completion certificate and how do I get one in {location}?",
             "A completion certificate from {location_council} Building Control (or an approved inspector) confirms your works comply with Building Regulations. It is essential for selling or re-mortgaging — lenders and conveyancers require it. We manage the inspection sequence and close out sign-off as part of every Complete package."),
            ("Do I need an energy performance certificate after building work in {location}?",
             "Extensions and loft conversions in {location} that change the building's energy characteristics require an updated EPC (or SAP/SBEM calculation as part of Part L compliance). We include Part L calculations in every Complete and Bespoke package."),
        ],
    },
    ...
    "loft-conversions": {
        ...
        "local_faqs": [
            ...
            ("What types of loft conversion suit {location} homes?",
             "{location}'s {typical_housing_short} stock lends itself to rear dormers (most common), hip-to-gable (semi-detached), and mansard (period terraces and conservation contexts). Velux-only conversions are possible where ridge height allows. We recommend the best structural and planning route at survey."),
            ("What postcodes do you cover for loft conversions in {location}?",
             "We cover all {location} postcodes — {postcodes} — with surveyors based locally. Survey appointments within 3 working days. Our structural engineer is London-based and attends site when required."),
            ("Do I need a Party Wall agreement for a loft conversion in {location}?",
             "Most {location} loft conversions require Party Wall notices to adjoining neighbours — typically for steel beam installation and/or raising the party wall. We can co-ordinate the notice process; our in-house engineer handles the structural element. The Act gives neighbours 14 days to respond."),
        ],
    },
    ...
    "house-extensions": {
        ...
        "local_faqs": [
            ...
            ("What type of extension suits {location} houses best?",
             "{location}'s {typical_housing_short} terraced and semi-detached stock typically suits rear single-storey extensions (kitchen-diners), side-return infill extensions, or double-storey rear. Wraparound extensions combine both directions for maximum gain. We recommend the most viable option at the free site visit."),
            ("What postcodes do you cover for extensions in {location}?",
             "We cover all {location} postcodes — {postcodes} — with local surveyors. Survey appointments within 3 working days. Fixed fees — no hourly billing."),
            ("How does {location_council} approach extension design?",
             "{location_council} follows the London Plan and its own Local Development Framework. Extensions must match or complement existing materials, respect neighbour amenity and comply with Part L. We include a Pre-Application Advice summary where the planning history is complex."),
        ],
    },
    ...
    "mansard-roof": {
        ...
        "local_faqs": [
            ...
            ("What postcodes do you cover for mansard roofs in {location}?",
             "We cover all {location} postcodes — {postcodes} — and have submitted mansard applications across the borough. Our heritage statement and design-and-access statement are included in every mansard package."),
            ("Can my {location} terraced house have a mansard?",
             "{location}'s {typical_housing_short} terraced stock is the natural context for mansard extensions — they were originally designed for Victorian and Edwardian rows. Feasibility depends on street precedent, conservation area status and party wall implications. We assess all three at the free site visit."),
            ("How many storeys does a mansard add in {location}?",
             "A mansard adds a full upper storey — typically 35–45m² of usable floor space. In {location} this often converts a 3-bed house to 4 or 5 beds. The steep front slope (70°) and flat top read as a roof, not a full floor, which is why {location_council} accepts them more readily than a simple box extension."),
        ],
    },
